...
//This is a proxy of the request function. We need it beacause disguise the route we are useing to use the github api.We are receiving a request from the app.get route for github right below this.
