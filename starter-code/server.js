...
const conString = 'postgres://postgres:minute5@localhost:5432/kilovolt'; // DONE: Don't forget to set your own conString
...
//This is a proxy of the request function. We need it beacause disguise the route we are useing to use the github api.We are receiving a request from the app.get route for github right below this. This is a url request.
...
//This is sends the client the correct page based on the request from the url.
...
// COMMENT: What is this route doing? Where does it receive a request from?
//This is an ajax request. Anytime there is a new article we are updating the database with the author stuff into the authors table, then updates the articles table with the article info, then gives us an update message, and a possible error message in case of an error.
